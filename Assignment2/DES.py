...
def encrypt(plaintext, roundkey_bin, roundkey_hex): 
	plaintext = hextobin(plaintext) 
	
	# Initial Permutation 
	plaintext = permute(plaintext, initial_perm, 64) 
	print("After inital permutation", bintohex(plaintext)) 
	...
	for i in range(0, 16): 
		...
		sbox_str = permute(sbox_str, pBox, 32) 
		...
		print("Round ", i + 1, " ", bintohex(left), " ", bintohex(right), " ", roundkey_hex[i]) 
...
# print(roundkey_hex)
print("Encryption") 
cipher_text = bintohex(encrypt(plaintext, roundkey_bin, roundkey_hex)) 
print("Cipher Text : ",cipher_text) 
print("Decryption") 
roundkey_bin_rev = roundkey_bin[::-1] 
roundkey_hex_rev = roundkey_hex[::-1] 
text = bintohex(encrypt(cipher_text, roundkey_bin_rev, roundkey_hex_rev)) 
print("Plain Text : ",text) 
print("After ciphertext is decrypted, one gets the original plaintext. ")
print("The output of the 1st encryption round is identical to the output of the 15th decryption round as we can see above")
